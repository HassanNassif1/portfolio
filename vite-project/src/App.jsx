            ...
            <div className="contact-container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
              <div className="contact-info animate-on-scroll fade-in-left" style={{ 
                ...
                <div className="contact-item" style={{ 
                  ...
                  <div className="contact-icon-box" style={{ fontSize: '2rem', color: '#4a9eff', minWidth: '50px' }}><i className="fas fa-envelope"></i></div>
                  <div>
                    <h4 style={{ fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '1px', color: '#8892b0', marginBottom: '0.25rem' }}>Secure Email</h4>
                    <a href="mailto:hassannassif.lb@gmail.com" style={{ color: '#ccd6f6', textDecoration: 'none', fontSize: '1rem' }}><i className="fas fa-at" style={{ marginRight: '8px', color: '#4a9eff' }}></i> hassannassif.lb@gmail.com</a>
                  </div>
                </div>
                <div className="contact-item" style={{ 
                  display: 'flex', 
                  ...
                  <div className="contact-icon-box" style={{ fontSize: '2rem', color: '#4a9eff', minWidth: '50px' }}><i className="fas fa-phone-alt"></i></div>
                  <div>
                    <h4 style={{ fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '1px', color: '#8892b0', marginBottom: '0.25rem' }}>Direct Comm Line</h4>
                    <a href="tel:+96170748266" style={{ color: '#ccd6f6', textDecoration: 'none', fontSize: '1rem' }}><i className="fas fa-phone" style={{ marginRight: '8px', color: '#4a9eff' }}></i> +961 70 748 266</a>
                  </div>
                </div>
                <div className="contact-item" style={{ 
                  display: 'flex', 
                  ...
                  <div className="contact-icon-box" style={{ fontSize: '2rem', color: '#4a9eff', minWidth: '50px' }}><i className="fab fa-linkedin-in"></i></div>
                  <div>
                    <h4 style={{ fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '1px', color: '#8892b0', marginBottom: '0.25rem' }}>Network Node</h4>
                    <a href="https://www.linkedin.com/in/hassan-nassif-0b6b29313/" target="_blank" rel="noopener noreferrer" style={{ color: '#ccd6f6', textDecoration: 'none', fontSize: '1rem' }}><i className="fab fa-linkedin" style={{ marginRight: '8px', color: '#4a9eff' }}></i> linkedin.com/in/hassan-nassif</a>
                  </div>
                </div>
                <div className="contact-item" style={{ 
                  display: 'flex', 
                  ...
                  <div className="contact-icon-box" style={{ fontSize: '2rem', color: '#4a9eff', minWidth: '50px' }}><i className="fab fa-instagram"></i></div>
                  <div>
                    <h4 style={{ fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '1px', color: '#8892b0', marginBottom: '0.25rem' }}>Social Stream</h4>
                    <a href="https://www.instagram.com/hassan_nassiff?igsh=MWZvdmdtdWUxbWdwcg%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" style={{ color: '#ccd6f6', textDecoration: 'none', fontSize: '1rem' }}><i className="fab fa-instagram" style={{ marginRight: '8px', color: '#4a9eff' }}></i> @hassannassif</a>
                  </div>
                </div>
              </div>
            </div>
